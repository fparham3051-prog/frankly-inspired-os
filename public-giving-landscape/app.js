(function(){
  ...
  // Click-to-open breakdown: gift type, restriction, impact, trend signal,
  // and a replication idea, as short labeled data fields rather than a
  // paragraph. Renders nothing (no empty disclosure) when a gift has none of
  // these filled in yet - e.g. older rows logged before this was added.
  function giftCaseStudyHtml(g){
    ...
    return '<details class="gift-cs"><summary>View case study breakdown</summary>' +
      '<div class="gift-cs-grid">' +
